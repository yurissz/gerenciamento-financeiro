...
export const CobrancasPage: React.FC<CobrancasProps> = ({ style, onClick, arrayCharges, idCob, setIdCob,
                    ...
                    <tbody>
                        {arrayCharges.map((charge, index) => (
                            <tr key={index} className={styles.alingItens}>
                                <td className={styles.styleItens} onClick={() => descriptionClick(charge.id_cob)}>{charge.nome}</td>
                                ...
                                <td className={styles.styleItens} onClick={() => descriptionClick(charge.id_cob)}>{formatDate(charge.data_venc)}</td>
